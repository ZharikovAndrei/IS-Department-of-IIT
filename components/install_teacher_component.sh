...
base_path=../kb/is-department-of-iit/components/teachers_load.component/src
...
cp -Rfv $base_path/components/teachers_load/static/* $sc_web_static_path

stage "Install component"

append_js $sc_web_path/templates/components.html components/js/teachers_load/build.js
