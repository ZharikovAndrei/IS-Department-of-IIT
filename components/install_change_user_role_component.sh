...
base_path=../kb/is-department-of-iit/components/change_user_role.component/src
...
cp -Rfv $base_path/components/change_user_role/static/* $sc_web_static_path

stage "Install component"

append_js $sc_web_path/templates/components.html components/js/change_user_role/build.js
