...
base_path=../kb/is-department-of-iit/components/course_projects_table.component/src
...
cp -Rfv $base_path/components/course_projects_table/static/* $sc_web_static_path

stage "Install component"
z
append_js $sc_web_path/templates/components.html components/js/course_projects_table/course_projects_table.js
append_css $sc_web_path/templates/components.html components/css/course_projects_table/course_projects_table.css
